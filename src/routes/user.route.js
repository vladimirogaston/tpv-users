...
const { createUserSchema, createCustomerSchema, validateLoginSchema } = require('../models/validations/userValidator.middleware')
...
function auth(req, res, next) {
   ...
   *                 $ref: '#/components/schemas/User'
   */
  router.get('/:id', auth, awaitHandlerFactory(getUserById))
   ...
   *         description: Some server error
   */
  router.post('/login', validateLoginSchema, awaitHandlerFactory(userLogin))
